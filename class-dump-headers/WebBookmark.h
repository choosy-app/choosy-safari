...
@class NSString, WebBookmarkGroup;
...
+ (id)_bookmarkFromDictionaryRepresentation:(id)fp8 topLevelOnly:(BOOL)fp12 withGroup:(id)fp16;
+ (id)bookmarkFromDictionaryRepresentation:(id)fp8 withGroup:(id)fp12;
